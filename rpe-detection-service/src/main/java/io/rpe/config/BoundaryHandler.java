 ...
 *
 * <p>Enforced by the ArchUnit rule {@code broadCatchOnlyInBoundaryHandlers} (RpeArchTest):
...
public @interface BoundaryHandler {
    /** Why broad catch is the correct last resort, e.g. "kafka-listener-top-level". */
    String value();
}
