 ...
 *
 * <p>Enforced by the ArchUnit rule {@code broadCatchOnlyInBoundaryHandlers} (AlertArchTest):
...
public @interface BoundaryHandler {
    /** Why broad catch is the correct last resort, e.g. "scheduled-purge-must-survive". */
    String value();
}
