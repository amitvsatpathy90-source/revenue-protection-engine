...
/**
 * Zero-trust Actuator hardening for the alert service (servlet surface, ADR-19). Identical
 * policy to the detection reactive chain in the {@code HttpSecurity} idiom. Per-service copy
 * by design (no shared rpe-common jar). {@link ConditionalOnWebApplication}(SERVLET) keeps
 * these beans out of the {@code webEnvironment = NONE} integration context.
 */
@Configuration
@EnableWebSecurity
