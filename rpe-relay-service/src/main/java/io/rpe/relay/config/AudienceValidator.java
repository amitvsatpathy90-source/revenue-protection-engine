 ...
 * OAuth2 confused-deputy hole (a token minted for another relying party must not be accepted).
 * Error message carries no token data (no PII/secret). Package-private (boundary isolation).
 */
